...
(function () {
  ...
  require.config({
    ...
    paths: {
      ...
      nmodule: '/module',
      'nmodule/devTrafficLights': 'build/karma/src',
      'nmodule/devTrafficLightsTest': 'build/karma/srcTest',
  ...
  define('nmodule/devTrafficLights/rc/devTrafficLights.built.min');
  ...
  require([ 'niagara-test-server/karmaUtils',
     ...
     */
    //testOnly('rc/devTrafficLights');
    testOnly('');

    karmaUtils.setupAndRunSpecs({
      user: 'admin',
      pass: 'asdf1234',
      specs: [ 'nmodule/devTrafficLightsTest/rc/spec/allSpecs' ]
    }, function (err) {
