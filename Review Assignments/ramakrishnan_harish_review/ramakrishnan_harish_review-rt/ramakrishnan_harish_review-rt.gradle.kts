...
description = "Harish N Ramakrishnan Niagara Review Assignment"

moduleManifest {
  moduleName.set("ramakrishnan_harish_review")
...
tasks.named<Bajadoc>("bajadoc") {
  ...
  // enumerated below
  includePackage("com.tridiumuniversity.ramakrishnan_harish_review")
}
