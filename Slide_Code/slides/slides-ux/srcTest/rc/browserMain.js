...
(function () {
  ...
  require.config({
    ...
    paths: {
      ...
      nmodule: '/module',
      'nmodule/slides': 'build/karma/src',
      'nmodule/slidesTest': 'build/karma/srcTest',
  ...
  define('nmodule/slides/rc/slides.built.min');
  ...
  require([ 'niagara-test-server/karmaUtils',
    ...
    karmaUtils.setupAndRunSpecs({
      user: 'admin',
      pass: 'asdf1234',
      specs: [ 'nmodule/slidesTest/rc/spec/allSpecs' ]
    }, function (err) {
