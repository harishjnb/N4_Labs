...
@NiagaraSingleton
public class BDemoView
  extends BSingleton implements BIJavaScript, BIFormFactorMax
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.tridiumuniversity.slides.ux.BDemoView(871993280)1.0$ @*/
/* Generated Fri Oct 20 10:24:06 EDT 2023 by Slot-o-Matic (c) Tridium, Inc. 2012-2023 */

  public static final BDemoView INSTANCE = new BDemoView();

  //region Type

  @Override
  public Type getType() { return TYPE; }
  public static final Type TYPE = Sys.loadType(BDemoView.class);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  ...
  private static final JsInfo jsInfo = JsInfo.make(
    BOrd.make("module://slides/rc/bajaux/DemoView.js"),
    BSlidesJsBuild.TYPE
  );
}
