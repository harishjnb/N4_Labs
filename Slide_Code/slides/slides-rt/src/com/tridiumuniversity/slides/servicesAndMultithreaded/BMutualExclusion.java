...
public class BMutualExclusion
  extends BComponent
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.tridiumuniversity.slides.servicesAndMultithreaded.BMutualExclusion(770752608)1.0$ @*/
/* Generated Tue Oct 10 09:36:32 EDT 2023 by Slot-o-Matic (c) Tridium, Inc. 2012-2023 */
  ...
  public static final Type TYPE = Sys.loadType(BMutualExclusion.class);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  ...
  private void doIncrementInternal(Context cx)
  {
    synchronized (incrementSyncObject)
    {
      setNumber(getNumber() + 1);
    }
  }

  private final Object incrementSyncObject = new Object();
}
